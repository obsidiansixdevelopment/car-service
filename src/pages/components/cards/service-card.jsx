  ...
  return (
    <div className="border-[#858587] border-4 md:p-4 sm:p-3 p-2 rounded-xl group">
        <div className="relative md:h-72 sm:h-56 h-44 w-full">
            ...
            Enhance engine performance and fuel efficiency by removing carbon deposits with our advanced cleaning technology.
            </p>
        </div>
        <p className="md:text-xl sm:text-base text-sm font-semibold text-white text-center p-2 md:px-2">Catalytic Converter Cleaning</p>
    </div>
  )
}
