...
const Sehdule = () => {
  ...
  <div className="font-medium text-center">
        ...
        <button type="button" className="text-white bg-primary-main hover:bg-primary-main focus:ring-4 focus:outline-none focus:ring-primary-main font-medium rounded-lg md:text-base text-base px-4 py-2 text-center dark:bg-primary-main dark:hover:bg-primary-main dark:focus:ring-primary-main">Make an Appointment</button>
    </div>
  </div>
</div>
  )
